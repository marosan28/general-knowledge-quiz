...
- __Footer__
  ...
  - The footer is on the bottom of the page it contains general information of which year the quiz was made and who the website was developed by.
    
![App Screenshot](wireframes/images/footer.png)

- __Username and Score__

  - Before starting, the user is prompted to enter the username he will be using to play the game. 
  ![App Screenshot](wireframes/images/username.png)

  - There is a username and score tracker at the top of the page.
...
![App Screenshot](wireframes/images/score.png)

- __Progress Bar__

  - The progress bar is above the questions container to keep the player engaged in the game. The progress bar is incrementing everytime the user answers the question. 
  ![App Screenshot](wireframes/images/progress.png)
...
- __Question Box__
  ...
  - Next/Quit button at the bottom, where the User can click to continue on to the next question or Quit the game.
    
![App Screenshot](wireframes/images/questions.png)

- __Finished Game__

  - At the end of the game the User can see the score achieved along with his username and an interactive message.
  - There is a restart button to start the game from the beginning.

![App Screenshot](wireframes/images/end.png)
...
-   ### Design
    -   #### Colour Scheme
        -   The colour palette used on this website is: 
            ...
            ![App Screenshot](wireframes/images/palete.png)

            The color scheme for this project includes four main colors: Sunglow (#fcc838ff), Violet JTC (#6b4060ff), Yinmn Blue (#304c77ff), White (#ffffffff), and Black (#000000ff). Yinmn Blue and Violet JTC were used together in a linear gradient for the background, while Sunglow was used for buttons and the footer. The White color was used for the question box on the quiz and for text, while the Black color was used for some accents.

            Yinmn Blue and Violet JTC work well together to create a harmonious and calming color palette, perfect for a quiz website. Sunglow, on the other hand, is a vibrant and energetic color that can help draw attention to important elements on the page.

            The colour palette was generated by [Coolors website](https://coolors.co/).

    -   #### Typography
        -   The *Calistoga* font is the main font used throughout the whole website with Sans Serif as the fallback. *Calistoga* is a decorative font that has a playful, casual look and feel. This font choice was made to give the website a lighthearted and fun vibe, making the content more engaging and enjoyable for users.
